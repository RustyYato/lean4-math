...
instance : Max (Subgroup α) := inferInstance
instance : Min (Subgroup α) := inferInstance
...
instance : Max (AddSubgroup α) := inferInstance
instance : Min (AddSubgroup α) := inferInstance
