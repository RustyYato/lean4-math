...
instance [SemiringOps α] [IsNonUnitalNonAssocSemiring α] [DecidableEq n] [Fintype n] : SemiringOps (Matrix α n n) := SemiringOps.mk
...
instance [Add α] [Zero α] [IsAddSemigroup α] [IsAddCommMagma α] [MonoidOps α] [IsMonoid α] [DecidableEq n] [Fintype n] [DecidableEq n] : MonoidOps (Matrix α n n) := instMonoidOpsOfMulOfOneOfPowNat
