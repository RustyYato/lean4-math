...
--   [AddMonoidOps γ] [IsAddCommMagma γ] [IsAddMonoid γ]
--   [AddMonoidOps γ₁] [IsAddCommMagma γ₁] [IsAddMonoid γ₁]
--   (f: DFinsupp α S) (g₀: ∀i, α i -> DFinsupp γ S) (g₁: ι -> γ -> γ₁)
--   (map_add: ∀i a b, g₁ i (a + b) = g₁ i a + g₁ i b)
--   {h₀: ∀i, g₀ i 0 = 0}
--   {h₁: ∀i, g₁ i 0 = 0}:
...
-- def sum_eq_pairwise [∀i, Zero (α i)] [Zero β]  [AddMonoidOps γ] [IsAddCommMagma γ] [IsAddMonoid γ]
--   (f₀: DFinsupp α S)
--   (f₁: DFinsupp β S)
--   (g₀: ∀i, α i -> γ)
--   (g₁: ι -> β -> γ)
