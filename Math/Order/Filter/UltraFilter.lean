...
structure UltraFilterBase (α: Type*) [LE α] [LT α] [Inf α] [Bot α] [IsSemiLatticeInf α] [IsAtomic (FilterBase α)] extends FilterBase α where
...
variable [LE α] [LT α] [Inf α] [Bot α] [IsSemiLatticeInf α] [IsAtomic (FilterBase α)]
